<template>
  <a-modal class="image-cropper" v-model:visible="visible" title="编辑图片" :footer="false" @cancel="closeModal">
    ...
    <!-- 协同编辑操作 -->
    <div class="image-edit-actions" v-if="isTeamSpace" style="text-align: center;">
      <a-space>
...
const isTeamSpace = computed(() => {
  console.error('props.space:', props.space); // 查看 props.space 的值
  // message.error(String(props.space?.spaceType === SPACE_TYPE_ENUM.TEAM))
